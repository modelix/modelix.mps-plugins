...
/*Generated by MPS */
class CloudNodeGroupSetPropertyActionGroup(plugin: ApplicationPlugin) :
    ...
    public override fun doUpdate(event: AnActionEvent) {
        ...
        for (role: SProperty in Sequence.fromIterable(properties).sort(
            ...
            this@CloudNodeGroupSetPropertyActionGroup.addParameterizedAction(
                SetPropertyAction(node, role),
                node,
                role,
            )
        }
