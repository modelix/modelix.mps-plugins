    ...
    fun cloud2mps() {
        ...
        try {
            ...
            val modelServerConnection: ModelServerConnection =
                ModelServerConnections.Companion.getInstance().ensureModelServerIsPresent(modelServerURL)
                                                            ...
                                                            var id: Long? = Sequence.fromIterable<Long>(allChildren)
                                                                .findFirst(object : IWhereFilter<Long?>() {
                                                                    override fun accept(it: Long?): Boolean {
                                                                        return@computeWriteT check_d5jcfl_a0a0a0a2a0a0a6a0a0a0a0a0a0a0a0a0a1a0a0f0a0c(
                                                                            t.getConcept(
                                                                                (it)!!
                                                                            ), projectConcept
                                                                        )
