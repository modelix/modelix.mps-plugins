...
/*Generated by MPS */
class CloudActionsForPhysicalProjectsCloudActionsActionGroup(plugin: ApplicationPlugin) :
        ...
        for (treeInRepository: CloudRepository in Sequence.fromIterable<CloudRepository>(
            ...
            treeInRepository.processProjects(object : Consumer<SNode> {
                override fun accept(pr: SNode) {
                    this@CloudActionsForPhysicalProjectsCloudActionsActionGroup.addParameterizedAction(
                        CopyAndSyncPhysicalProjectOnCloudAction(treeInRepository, pr),
                        treeInRepository,
                        pr,
                    )
                }
            ...
            this@CloudActionsForPhysicalProjectsCloudActionsActionGroup.addParameterizedAction(
                CopyAndSyncPhysicalProjectOnCloudAction(treeInRepository, null),
                treeInRepository,
                null,
            )
        }
