...
class ModelCloudExporter {
    ...
    constructor(url: String?, repositoryId: String?, branchName: String?) {
        ...
        val modelServer: ModelServerConnection? = ModelServerConnections.Companion.getInstance().getModelServer(url)
        if (modelServer == null) {
    ...
    constructor(
        ...
        branchName: String? = treeInRepository.getActiveBranch().branchName
    ) {
    ...
    fun export(outputFolder: IFile, selectedModuleIds: Set<Long>?, mpsProject: Project?): List<Solution> {
        ...
        val url: String? = repositoryInModelServer.getModelServer().getBaseUrl()
