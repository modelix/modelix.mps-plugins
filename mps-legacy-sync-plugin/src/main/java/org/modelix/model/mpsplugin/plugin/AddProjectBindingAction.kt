...
/*Generated by MPS */
class AddProjectBindingAction : BaseAction("Bind to Current Project", "", ICON) {
    init {
    ...
    public override fun doExecute(event: AnActionEvent, _params: Map<String, Any>) {
        ...
        if (!(Objects.equals(expectedProjectName, event.getData(MPSCommonDataKeys.MPS_PROJECT)!!.name))) {
