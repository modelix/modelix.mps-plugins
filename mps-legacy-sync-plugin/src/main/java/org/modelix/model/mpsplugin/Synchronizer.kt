 ...
 */
abstract class Synchronizer<MPSChildT : Any>(cloudParentId: Long, cloudRole: String?) {
    ...
    open fun syncToMPS(tree: ITree): Map<Long, MPSChildT> {
        val expectedChildren: List<Long> = getCloudChildren(tree).toList()
    ...
    fun syncToCloud(t: IWriteTransaction): Map<Long, MPSChildT> {
        ...
        val mappings = associate(t.tree, existingChildren, expectedChildren, SyncDirection.TO_CLOUD)
