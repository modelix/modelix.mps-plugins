...
/*Generated by MPS */
class MPSArea @JvmOverloads constructor(val repository: SRepository? = MPSModuleRepository.getInstance()) : IArea,
    IAreaReference {
    ...
    public override fun <T> executeRead(f: Function0<T>): T {
        val result: _T<T> = _T()
    ...
    public override fun <T> executeWrite(f: Function0<T>): T {
        val result: _T<T> = _T()
