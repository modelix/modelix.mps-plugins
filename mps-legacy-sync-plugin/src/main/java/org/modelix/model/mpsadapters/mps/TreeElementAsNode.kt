...
/*Generated by MPS */
abstract class TreeElementAsNode<E>(element1: E) : INode {
    val element: E?
    ...
    public override fun getConceptReference(): IConceptReference? {
        return check_bnhhyh_a0a8(concept, this)
    }
    ...
    public override fun addNewChild(role: String?, index: Int, concept: IConcept?): INode {
        val accessor: IChildAccessor<*>? = getChildAccessor(role)
        if (accessor == null) {
    ...
    public override fun getPropertyValue(role: String): String? {
        val accessor: IPropertyAccessor<*>? = getPropertyAccessor(role)
        if (accessor == null) {
    ...
    public override fun getReferenceTarget(role: String): INode? {
        val accessor: IReferenceAccessor<*>? = getReferenceAccessor(role)
        if (accessor == null) {
    ...
    companion object {
        ...
        private fun <E> check_bnhhyh_a0a8(
            checkedDotOperand: IConcept?,
            checkedDotThisExpression: TreeElementAsNode<E>
        ): IConceptReference? {
        ...
        private fun <E> check_bnhhyh_a0a13(
