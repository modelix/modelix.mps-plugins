...
/*Generated by MPS */
class SNodeToNodeAdapter private constructor(node1: SNode) : INodeEx {
    ...
    public override fun getAllChildren(): Iterable<INode> {
        notifyModelContentDependency()
    ...
    public override fun getPropertyValue(property: IProperty): String? {
        return node.getProperty((property as SPropertyAdapter).getProperty())
    }
    ...
    public override fun setPropertyValue(property: IProperty, value: String?) {
        node.setProperty((property as SPropertyAdapter).getProperty(), value)
    }

    public override fun setReferenceTarget(link: IReferenceLink, target: INode?) {
        val snodeTarget: SNode? = wrap(target)
