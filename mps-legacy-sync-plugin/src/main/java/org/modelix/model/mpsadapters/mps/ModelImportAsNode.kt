...
class ModelImportAsNode(importedModel: SModel, private val importingModel: SModel) :
    ...
    override val reference: INodeReference
        get() {
            return NodeReference(getElement().getReference(), importingModel.getReference())
        }
    ...
    companion object {
        private val modelAccessor: IReferenceAccessor<SModel?> = object : IReferenceAccessor<SModel?> {
            public override fun get(model: SModel?): INode? {
                return SModelAsNode.Companion.wrap(model)
            }
